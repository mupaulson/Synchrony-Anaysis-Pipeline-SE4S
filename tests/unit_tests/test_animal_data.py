...
class TestAnimalData(unittest.TestCase):
    ...
    def test_get_data_for_cell_all(self):
        ...
        animal = AnimalData(1234, cell_data)
        expected_data = [(1, 0.5), (2, 0.6)]
        self.assertEqual(animal.get_data_for_cell("C001"), expected_data)
    ...
    def test_get_data_for_cell_nonexistent(self):
        # Test retrieving data for a cell that doesn't exist
    ...
    def test_get_data_at_time_nonexistent(self):
        # Test retrieving data at a timestamp that does not exist
        # If so, it should return None for all cells.
